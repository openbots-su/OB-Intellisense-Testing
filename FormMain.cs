...
namespace Intillisense
{
	public class FormMain : System.Windows.Forms.Form
	{
		...
		private CompletionList currentCompletionList;
		private string prexistingVarDecs;
		#endregion
		...
		private void selectItem()
		{
			if ( this.wordMatched )
			{
				...
				CompletionItem matchedResult = currentCompletionList.Items.Where(item => item.DisplayText == fill).FirstOrDefault();
				/*
				...
				*/
				...
				this.richTextBox1.Text = this.richTextBox1.Text.Substring(0, matchedResult.Span.Start - prexistingVarDecs.Length) + fill;
